...
/opt/cplex/cplex/bin/x86-64_sles10_4\.1/cplex -c "READ networks/$1/relax/model.lp" "SET timelimit 3600" "SET threads 4" "SET logfile networks/$1/relax/exec.txt" "SET output writelevel 4" "OPTIMIZE" "WRITE networks/$1/lower2/solution.sol" "y"
