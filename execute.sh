...
cplex/cplex -c "READ networks/$1/$1.lp" "SET timelimit 3600" "SET threads 4" "SET logfile networks/$1/$1-exec-lower.txt" "SET output writelevel 3" "OPTIMIZE" "WRITE networks/$1/$1-lower.sol" "y"
...
# Format of the table
# "| TEST NAME | NODE COUNT | LINK COUNT | FLOW COUNT | TIME RAN | SOLUTION FOUND | GAP | LOWER BOUND"
echo "|$(echo $1 | sed 's/_/\\_/g')|$nodes|$links|$flows|$time_ran|$sol|$gap|$lower|"
