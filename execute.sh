...
#glpsol -m glpk/into-lower.mod -d networks/$1/input.dat --wlp networks/$1/standard/model.lp --check

# Execute cplex and put the output into the file folder
#cplex/cplex -c "READ networks/$1/standard/model.lp" "SET timelimit 3600" "SET threads 4" "SET logfile networks/$1/standard/exec.txt" "SET output writelevel 3" "OPTIMIZE" "WRITE networks/$1/standard/solution.sol" "y"
