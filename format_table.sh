...
into_time_ran=$(cat networks/$1/standard/exec.txt | grep "Solution time =" | awk '{print $4}')
...
echo "|$(echo $1 | sed 's/_/\\_/g')|$nodes|$links|$flows|$into_sol|$into_time_ran|$vrp_sol|$vrp_time_ran|$lower|$lower2|"
